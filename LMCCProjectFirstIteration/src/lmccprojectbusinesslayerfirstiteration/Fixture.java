...
public class Fixture implements Serializable
{
    ...
    public Fixture(FixtureType fixtureType, Team team,
    ...
    // TODO remove unnecessary setters for fixture
    /**
    ...
    /**
     * TODO change toString for Fixture
     * Return the string representing this fixture
     *
     * @return the string
     */
    @Override
    ...
    {
        return this.fixtureNumber + " " + this.team.toString() + " " + this.date + " "
                + this.opposition + " "
                + this.season;
    }
